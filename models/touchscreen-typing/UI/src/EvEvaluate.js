...
// TODO
// Horizontal process bar, vertical process bar, estimated remaining time: only UI
...
class EvEvaluate extends Component {
  ...
  startEvaluation = () => {
    // Todo: Progress of training/evaluation still cannot be fetched even with --verbose
    ...
    function evaDone() {
      currentComponent.props.history.push("/evaluate/process1");
    }
